...
void InstructionWriter::writeString(String const &str) {
	...
	activeSegment->insert(activeSegment->cend(), encodedString.cbegin(), encodedString.cend());
}
