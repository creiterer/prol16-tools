...
TEST(DisassemblerTest, testMultipleInstructions) {
	...
	expectedOutput << "0002:\t" << "loadi r0, 8080h" << std::endl;
	expectedOutput << "0004:\t" << "load r1, r0" << std::endl;
	expectedOutput << "0005:\t" << "store r1, r0" << std::endl;
	expectedOutput << "0006:\t" << "move r1, r0" << std::endl;
	expectedOutput << "0007:\t" << "jump r0" << std::endl;
	expectedOutput << "0008:\t" << "jumpc r0" << std::endl;
	expectedOutput << "0009:\t" << "jumpz r0" << std::endl;
	expectedOutput << "000A:\t" << "and r1, r0" << std::endl;
	expectedOutput << "000B:\t" << "or r1, r0" << std::endl;
	expectedOutput << "000C:\t" << "xor r1, r0" << std::endl;
	expectedOutput << "000D:\t" << "not r1" << std::endl;
	expectedOutput << "000E:\t" << "add r1, r0" << std::endl;
	expectedOutput << "000F:\t" << "addc r1, r0" << std::endl;
	expectedOutput << "0010:\t" << "sub r1, r0" << std::endl;
	expectedOutput << "0011:\t" << "subc r1, r0" << std::endl;
	expectedOutput << "0012:\t" << "comp r1, r0" << std::endl;
